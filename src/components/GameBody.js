...
import './stylesheet/GameBody.scss';
    ...
    render() {
        ...
        return (
            <div className='game-body'>
                <BingoPlayer player='1P' bingo={player1Score}
                             result={player1Score >= 5 && player2Score >= 5 ? 'DRAW' : player1Score >= 5 ? 'WIN' : player2Score >= 5 ? "LOSE" : 'YET'}/>
                <BingoPlayer player='2P' bingo={player2Score}
                             result={player1Score >= 5 && player2Score >= 5 ? 'DRAW' : player2Score >= 5 ? 'WIN' : player1Score >= 5 ? "LOSE" : 'YET'}/>
            </div>
        );
    }
}
